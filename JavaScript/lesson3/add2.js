...
for (let user of users) {
    ...
    for (let key in user) {
        ...
        document.write(`<div class=address-block>`)
            document.write(`<p>City - ${user[adress].city} </p>`)
            document.write(`<p>Street - ${user[adress].street} </p>`)
            document.write(`<p>Suite - ${user[adress].suite} </p>`)
            document.write(`<p>Zip code - ${user[adress].zipcode} </p>`)
        document.write(`</div>`)
    }
    document.write(`</div>`)
}
