...
for (let simpson of simpsons){
    document.write(`<li>NAME-${simpson.name} SURNAME-${simpson.surname} AGE-${simpson.age} INFO-${simpson.info} <img class="product-image" src=${simpson.photo}></li>`)
    }
document.write(`</div>`)
for (let simpson of simpsons ){
    document.write(`<div>`)
    ...
    document.write(`<img class="product-image" src=${simpson.photo}>`)
    document.write(`</div>`)
}
/*
        Використовуючи данні з масиву, за допомоги document.write та циклу
